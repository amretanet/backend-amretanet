...
from app.models.products import ProductProjections
...
async def get_products(
    ...
    product_data, count = await GetManyData(
        db.products, pipeline, ProductProjections, {"page": page, "item": item}
    )
    ...
    response = ResponseFormatter(
        {"product_data": product_data, "pagination_info": pagination}, "", True
    )
